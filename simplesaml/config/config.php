...
$config = array (
	 ...
	 */
	'secretsalt' => 'defaultsecretsalandcorrectcode',
	...
	'technicalcontact_email'    => 'sistemas@ucol.mx',
	...
	'authproc.idp' => array(
		 ...
		 */
		 ...
		 90 => array(
			...
			'store' => array(
				'consent:Database', 
				'dsn' => 'mysql:host=localhost;dbname=consentimiento',
				'username' => 'root',
				'password' => '',
				'table'=>'consent',
			),
			'focus' 	=> 'yes', 
			'checked' 	=> TRUE,
			'hiddenAttributes'=> array('uCuenta','uDependencia','uInstitucion'),
		),
	...
	'authproc.sp' => array(
		...
		*/
		 ...
		 */
		//61 => array('class' => 'core:AttributeAdd', 'uInstitucion' => array('UCOL.wayf')),
